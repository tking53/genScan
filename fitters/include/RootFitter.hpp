...
struct RootFitter {
	...
	RootFitter(const pugi::xml_node& fitsettings) {
		...
		std::sort(this->ParamInfo.begin(), this->ParamInfo.end(), [](const std::tuple<int, bool, bool, std::string, double, double, double>& a, const std::tuple<int, bool, bool, std::string, double, double, double>& b) {
