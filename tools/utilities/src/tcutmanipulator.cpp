...
namespace manipulator {
	...
	class operation {
	public:
		operation(axis ax, double xc, double yc)
			: ax(ax)
			, xcom(xc)
			, ycom(yc) {
		}
	...
	public:
		shift(axis ax, double xc, double yc, double sv)
			: operation(ax, xc, yc)
			, value(sv) {
		}
	...
	public:
		mirror(axis ax, double xc, double yc, double sv)
			: operation(ax, xc, yc)
			, value(sv) {
		}
		virtual void apply(TCutG& cut) const {
	...
	public:
		zero(axis ax, double xc, double yc)
			: operation(ax, xc, yc) {
		}
		virtual void apply(TCutG& cut) const {
			auto npts = cut.GetN();
	...
	public:
		mult(axis ax, double xc, double yc, double value)
			: operation(ax, xc, yc)
			, value(value) {
		}
		virtual void apply(TCutG& cut) const {
	...
	public:
		set(axis ax, double xc, double yc, double value)
			: operation(ax, xc, yc)
			, value(value) {
		}
		virtual void apply(TCutG& cut) const {
