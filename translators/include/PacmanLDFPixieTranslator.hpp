#ifndef __PACMAN_LDF_PIXIE_TRANSLATOR_HPP__
#define __PACMAN_LDF_PIXIE_TRANSLATOR_HPP__
...
class PacmanLDFPixieTranslator : public Translator{
	public:
		PacmanLDFPixieTranslator(const std::string&,const std::string&);
		~PacmanLDFPixieTranslator();
