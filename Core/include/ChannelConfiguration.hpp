...
///@brief Shamelessly copied from pixie16/paass and cleaned of un needed parameters
#ifndef GENSCAN_CHANNELCONFIGURATION_HPP
#define  GENSCAN_CHANNELCONFIGURATION_HPP
