...
[[maybe_unused]] bool MtasProcessor::PreProcess(EventHistoryManager* eventhistory,[[maybe_unused]] PLOTS::PlotRegistry* hismanager,[[maybe_unused]] CUTS::CutRegistry* cutmanager){
	...
	if( (not this->AnySaturate) and (not this->AnyPileup) ){
		...
		for( int ii = 0; ii < 24; ++ii ){
			hismanager->Fill("MTAS_3201",this->SumFrontBackEnergy[ii],ii);
		}
		...
		for( int ii = 0; ii < 6; ++ii ){
			...
			hismanager->Fill("MTAS_3215",this->SumFrontBackEnergy[ii]);
			hismanager->Fill("MTAS_3225",this->SumFrontBackEnergy[ii+6]);
			hismanager->Fill("MTAS_3235",this->SumFrontBackEnergy[ii+12]);
			hismanager->Fill("MTAS_3245",this->SumFrontBackEnergy[ii+18]);

			hismanager->Fill("MTAS_3250",this->TotalEnergy[0],this->SumFrontBackEnergy[ii+6]);
			hismanager->Fill("MTAS_3250",this->TotalEnergy[0],this->SumFrontBackEnergy[ii+12]);
			hismanager->Fill("MTAS_3250",this->TotalEnergy[0],this->SumFrontBackEnergy[ii+18]);

			hismanager->Fill("MTAS_3252",this->TotalEnergy[0],this->SumFrontBackEnergy[ii]);

			hismanager->Fill("MTAS_3253",this->TotalEnergy[1],this->SumFrontBackEnergy[ii]);

			hismanager->Fill("MTAS_32508",this->TotalEnergy[0],this->SumFrontBackEnergy[ii+6]);
			hismanager->Fill("MTAS_32508",this->TotalEnergy[0],this->SumFrontBackEnergy[ii+12]);
			hismanager->Fill("MTAS_32508",this->TotalEnergy[0],this->SumFrontBackEnergy[ii+18]);

			hismanager->Fill("MTAS_32528",this->TotalEnergy[0],this->SumFrontBackEnergy[ii]);

			hismanager->Fill("MTAS_32538",this->TotalEnergy[1],this->SumFrontBackEnergy[ii]);

			if( (not this->InnerFire) and (not this->MiddleFire) and (not this->OuterFire) ){
				hismanager->Fill("MTAS_3254",this->TotalEnergy[0],this->SumFrontBackEnergy[ii]);
				hismanager->Fill("MTAS_32548",this->TotalEnergy[0],this->SumFrontBackEnergy[ii]);
			}
		}
	}
...
void MtasProcessor::FillBetaPlots(PLOTS::PlotRegistry* hismanager) const{
	if( (not this->AnySaturate) and (not this->AnyPileup) ){
		...
		for( int ii = 0; ii < 24; ++ii ){
			hismanager->Fill("MTAS_3301",this->SumFrontBackEnergy[ii],ii);
		}
		...
		for( int ii = 0; ii < 6; ++ii ){
			...
			hismanager->Fill("MTAS_3315",this->SumFrontBackEnergy[ii]);
			hismanager->Fill("MTAS_3325",this->SumFrontBackEnergy[ii+6]);
			hismanager->Fill("MTAS_3335",this->SumFrontBackEnergy[ii+12]);
			hismanager->Fill("MTAS_3345",this->SumFrontBackEnergy[ii+18]);

			hismanager->Fill("MTAS_3350",this->TotalEnergy[0],this->SumFrontBackEnergy[ii+6]);
			hismanager->Fill("MTAS_3350",this->TotalEnergy[0],this->SumFrontBackEnergy[ii+12]);
			hismanager->Fill("MTAS_3350",this->TotalEnergy[0],this->SumFrontBackEnergy[ii+18]);

			hismanager->Fill("MTAS_3352",this->TotalEnergy[0],this->SumFrontBackEnergy[ii]);

			hismanager->Fill("MTAS_3353",this->TotalEnergy[1],this->SumFrontBackEnergy[ii]);

			hismanager->Fill("MTAS_33508",this->TotalEnergy[0],this->SumFrontBackEnergy[ii+6]);
			hismanager->Fill("MTAS_33508",this->TotalEnergy[0],this->SumFrontBackEnergy[ii+12]);
			hismanager->Fill("MTAS_33508",this->TotalEnergy[0],this->SumFrontBackEnergy[ii+18]);

			hismanager->Fill("MTAS_33528",this->TotalEnergy[0],this->SumFrontBackEnergy[ii]);

			hismanager->Fill("MTAS_33538",this->TotalEnergy[1],this->SumFrontBackEnergy[ii]);

			if( (not this->InnerFire) and (not this->MiddleFire) and (not this->OuterFire) ){
				hismanager->Fill("MTAS_3354",this->TotalEnergy[0],this->SumFrontBackEnergy[ii]);
				hismanager->Fill("MTAS_33548",this->TotalEnergy[0],this->SumFrontBackEnergy[ii]);
			}
...
void MtasProcessor::FillNonBetaPlots(PLOTS::PlotRegistry* hismanager) const{
	if( (not this->AnySaturate) and (not this->AnyPileup) ){
		...
		for( int ii = 0; ii < 24; ++ii ){
			hismanager->Fill("MTAS_3101",this->SumFrontBackEnergy[ii],ii);
		}
		...
		for( int ii = 0; ii < 6; ++ii ){
			...
			hismanager->Fill("MTAS_3115",this->SumFrontBackEnergy[ii]);
			hismanager->Fill("MTAS_3125",this->SumFrontBackEnergy[ii+6]);
			hismanager->Fill("MTAS_3135",this->SumFrontBackEnergy[ii+12]);
			hismanager->Fill("MTAS_3145",this->SumFrontBackEnergy[ii+18]);

			hismanager->Fill("MTAS_3150",this->TotalEnergy[0],this->SumFrontBackEnergy[ii+6]);
			hismanager->Fill("MTAS_3150",this->TotalEnergy[0],this->SumFrontBackEnergy[ii+12]);
			hismanager->Fill("MTAS_3150",this->TotalEnergy[0],this->SumFrontBackEnergy[ii+18]);

			hismanager->Fill("MTAS_3152",this->TotalEnergy[0],this->SumFrontBackEnergy[ii]);

			hismanager->Fill("MTAS_3153",this->TotalEnergy[1],this->SumFrontBackEnergy[ii]);

			hismanager->Fill("MTAS_31508",this->TotalEnergy[0],this->SumFrontBackEnergy[ii+6]);
			hismanager->Fill("MTAS_31508",this->TotalEnergy[0],this->SumFrontBackEnergy[ii+12]);
			hismanager->Fill("MTAS_31508",this->TotalEnergy[0],this->SumFrontBackEnergy[ii+18]);

			hismanager->Fill("MTAS_31528",this->TotalEnergy[0],this->SumFrontBackEnergy[ii]);

			hismanager->Fill("MTAS_31538",this->TotalEnergy[1],this->SumFrontBackEnergy[ii]);

			if( (not this->InnerFire) and (not this->MiddleFire) and (not this->OuterFire) ){
				hismanager->Fill("MTAS_3154",this->TotalEnergy[0],this->SumFrontBackEnergy[ii]);
				hismanager->Fill("MTAS_31548",this->TotalEnergy[0],this->SumFrontBackEnergy[ii]);
			}
