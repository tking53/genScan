...
[[noreturn]] bool Analyzer::PreProcess([[maybe_unused]] EventHistoryManager* eventhistory,[[maybe_unused]] PLOTS::PlotRegistry* hismanager,[[maybe_unused]]CUTS::CutRegistry* cutmanager){
	this->console->error("Called Analyzer::PreProcess(EventHistoryManager*,PLOTS::PlotRegistry*,CUTS::CutRegistry*), not the overload");
	throw std::runtime_error("Called Analyzer::PreProcess(EventHistoryManager*,PLOTS::PlotRegistry*,CUTS::CutRegistry*), not the overload");
}

[[noreturn]] bool Analyzer::Process([[maybe_unused]] EventHistoryManager* eventhistory,[[maybe_unused]] PLOTS::PlotRegistry* hismanager,[[maybe_unused]]CUTS::CutRegistry* cutmanager){
	this->console->error("Called Analyzer::Process(EventHistoryManager*,PLOTS::PlotRegistry*,CUTS::CutRegistry*), not the overload");
	throw std::runtime_error("Called Analyzer::Process(EventHistoryManager*,PLOTS::PlotRegistry*,CUTS::CutRegistry*), not the overload");
}

[[noreturn]] bool Analyzer::PostProcess([[maybe_unused]] EventHistoryManager* eventhistory,[[maybe_unused]] PLOTS::PlotRegistry* hismanager,[[maybe_unused]]CUTS::CutRegistry* cutmanager){
	this->console->error("Called Analyzer::PostProcess(EventHistoryManager*,PLOTS::PlotRegistry*,CUTS::CutRegistry*), not the overload");
	throw std::runtime_error("Called Analyzer::PostProcess(EventHistoryManager*,PLOTS::PlotRegistry*,CUTS::CutRegistry*), not the overload");
}
