...
PidProcessor::PidProcessor(const std::string& log)
	: Processor(log, "PidProcessor", {"pid"}) {
	this->h1dsettings = {
		{1, {10000, -1000, 1000}},
		{2, {10000, -1000, 1000}},
		{3, {10000, -1000, 1000}},
	...
	this->h2dsettings = {
		...
		{25, {2000, -1000, 1000, 2000, 0, 16000}},
		{26, {2000, -1000, 1000, 2000, 0, 16000}},
		{27, {2000, -1000, 1000, 2000, 0, 16000}},
		{28, {2000, -1000, 1000, 2000, 0, 16000}},
		...
		{125, {2000, -1000, 1000, 2000, 0, 16000}},
		{126, {2000, -1000, 1000, 2000, 0, 16000}},
		{127, {2000, -1000, 1000, 2000, 0, 16000}},
		{128, {2000, -1000, 1000, 2000, 0, 16000}},

		// Start Pin vs Pin plots
		{200, {2000, 0, 16000, 2000, 0, 16000}},
		{201, {2000, 0, 16000, 2000, 0, 16000}},
		{202, {2000, 0, 16000, 2000, 0, 16000}},
		{203, {2000, 0, 16000, 2000, 0, 16000}},
		{204, {2000, 0, 16000, 2000, 0, 16000}},
		{205, {2000, 0, 16000, 2000, 0, 16000}},
...
[[maybe_unused]] bool PidProcessor::PreProcess(EventHistoryManager* eventhistory, [[maybe_unused]] PLOTS::PlotRegistry* hismanager, [[maybe_unused]] CUTS::CutRegistry* cutmanager) {
	...
	for (const auto& evt : this->SummaryData) {
		...
		// Start DB5:SCINT
		else if (this->currBOXID == BOXID::DB5 && this->currDETSUBTYPE == DETSUBTYPE::SCINT && this->currDETPOSITION == DETPOSITION::RIGHT) {
			FillStruct(evt, db5.scint.right);
		}
		// Start DB5:PPAC0
	...
	if (this->TOFFLIP) {
		...
		// db5 scint is only single sided (Up), calling it right since thats the line we send it down (db3.scint.right)
		this->fp1Tofs[8] = (fp1.xplas.at(0).time - db5.scint.right.time) + this->fp1TofShifts[8];
		this->fp1Tofs[9] = (fp1.xplas.at(1).time - db5.scint.right.time) + this->fp1TofShifts[9];
		...
		// db5 scint is only single sided (Up), calling it right since thats the line we send it down (db3.scint.right)
		this->fp2Tofs[8] = (fp2.xplas.at(0).time - db5.scint.right.time) + this->fp2TofShifts[8];
		this->fp2Tofs[9] = (fp2.xplas.at(1).time - db5.scint.right.time) + this->fp2TofShifts[9];
	} else {
		// FP1 based TOFs
		...
		// db5 scint is only single sided (Up), calling it right since thats the line we send it down (db3.scint.right)
		this->fp1Tofs[8] = (db5.scint.right.time - fp1.xplas.at(0).time) + this->fp1TofShifts[8];
		this->fp1Tofs[9] = (db5.scint.right.time - fp1.xplas.at(1).time) + this->fp1TofShifts[9];
		...
		// db5 scint is only single sided (Up), calling it right since thats the line we send it down (db3.scint.right)
		this->fp2Tofs[8] = (db5.scint.right.time - fp2.xplas.at(0).time) + this->fp2TofShifts[8];
		this->fp2Tofs[9] = (db5.scint.right.time - fp2.xplas.at(1).time) + this->fp2TofShifts[9];
	}

	hismanager->Fill("PID_001", fp1Tofs.at(0));
	hismanager->Fill("PID_002", fp1Tofs.at(1));
	hismanager->Fill("PID_003", fp1Tofs.at(2));
	hismanager->Fill("PID_004", fp1Tofs.at(3));
	hismanager->Fill("PID_005", fp1Tofs.at(4));
	hismanager->Fill("PID_006", fp1Tofs.at(5));
	hismanager->Fill("PID_007", fp1Tofs.at(6));
	hismanager->Fill("PID_008", fp1Tofs.at(7));

	hismanager->Fill("PID_009", fp1Tofs[0], fp1.pin.at(0).energy);
	hismanager->Fill("PID_010", fp1Tofs[0], fp1.pin.at(1).energy);
	hismanager->Fill("PID_011", fp1Tofs[0], fp1.pin.at(2).energy);
	hismanager->Fill("PID_012", fp1Tofs[0], fp1.pin.at(3).energy);

	hismanager->Fill("PID_013", fp1Tofs[2], fp1.pin.at(0).energy);
	hismanager->Fill("PID_014", fp1Tofs[2], fp1.pin.at(1).energy);
	hismanager->Fill("PID_015", fp1Tofs[2], fp1.pin.at(2).energy);
	hismanager->Fill("PID_016", fp1Tofs[2], fp1.pin.at(3).energy);

	hismanager->Fill("PID_017", fp1Tofs[4], fp1.pin.at(0).energy);
	hismanager->Fill("PID_018", fp1Tofs[4], fp1.pin.at(1).energy);
	hismanager->Fill("PID_019", fp1Tofs[4], fp1.pin.at(2).energy);
	hismanager->Fill("PID_020", fp1Tofs[4], fp1.pin.at(3).energy);

	hismanager->Fill("PID_021", fp1Tofs[6], fp1.pin.at(0).energy);
	hismanager->Fill("PID_022", fp1Tofs[6], fp1.pin.at(1).energy);
	hismanager->Fill("PID_023", fp1Tofs[6], fp1.pin.at(2).energy);
	hismanager->Fill("PID_024", fp1Tofs[6], fp1.pin.at(3).energy);

	hismanager->Fill("PID_025", fp1Tofs[8], fp1.pin.at(0).energy);
	hismanager->Fill("PID_026", fp1Tofs[8], fp1.pin.at(1).energy);
	hismanager->Fill("PID_027", fp1Tofs[8], fp1.pin.at(2).energy);
	hismanager->Fill("PID_028", fp1Tofs[8], fp1.pin.at(3).energy);
	...
	hismanager->Fill("PID_125", fp2Tofs[8], fp2.pin.at(0).energy);
	hismanager->Fill("PID_126", fp2Tofs[8], fp2.pin.at(1).energy);
	hismanager->Fill("PID_127", fp2Tofs[8], fp2.pin.at(2).energy);
	hismanager->Fill("PID_128", fp2Tofs[8], fp2.pin.at(3).energy);

	// PIN vs PIN plots
	hismanager->Fill("PID_200", fp1.pin.at(0).energy, fp1.pin.at(1).energy);
	hismanager->Fill("PID_201", fp1.pin.at(0).energy, fp1.pin.at(2).energy);
	hismanager->Fill("PID_202", fp1.pin.at(0).energy, fp1.pin.at(3).energy);
	hismanager->Fill("PID_203", fp2.pin.at(0).energy, fp2.pin.at(1).energy);
	hismanager->Fill("PID_204", fp2.pin.at(0).energy, fp2.pin.at(2).energy);
	hismanager->Fill("PID_205", fp2.pin.at(0).energy, fp2.pin.at(3).energy);
...
void PidProcessor::Init(const pugi::xml_node& config) {
	...
	this->TOFFLIP = config.attribute("TofFlip").as_bool(false);
...
void PidProcessor::DeclarePlots(PLOTS::PlotRegistry* hismanager) {
	hismanager->RegisterPlot<TH1F>("PID_001", "DB3P0 Anode - FP1XP1 TDiff; TDiff (ns)", this->h1dsettings.at(1));
	hismanager->RegisterPlot<TH1F>("PID_002", "DB3P0 Anode - FP1XP2 TDiff; TDiff (ns)", this->h1dsettings.at(2));
	hismanager->RegisterPlot<TH1F>("PID_003", "DB3P1 Anode - FP1XP1 TDiff; TDiff (ns)", this->h1dsettings.at(3));
	hismanager->RegisterPlot<TH1F>("PID_004", "DB3P1 Anode - FP1XP2 TDiff; TDiff (ns)", this->h1dsettings.at(4));
	hismanager->RegisterPlot<TH1F>("PID_005", "DB3 Scint L - FP1XP1 TDiff; TDiff (ns)", this->h1dsettings.at(5));
	hismanager->RegisterPlot<TH1F>("PID_006", "DB3 Scint L - FP1XP2 TDiff; TDiff (ns)", this->h1dsettings.at(6));
	hismanager->RegisterPlot<TH1F>("PID_007", "DB3 Scint R - FP1XP1 TDiff; TDiff (ns)", this->h1dsettings.at(7));
	hismanager->RegisterPlot<TH1F>("PID_008", "DB3 Scint R - FP1XP2 TDiff; TDiff (ns)", this->h1dsettings.at(8));

	hismanager->RegisterPlot<TH2F>("PID_009", "FP1: Pin 1 Energy vs DB3P0A-FP1XP1; TDiff (ns); Energy (keV)", this->h2dsettings.at(9));
	hismanager->RegisterPlot<TH2F>("PID_010", "FP1: Pin 2 Energy vs DB3P0A-FP1XP1; TDiff (ns); Energy (keV)", this->h2dsettings.at(10));
	hismanager->RegisterPlot<TH2F>("PID_011", "FP1: Pin 3 Energy vs DB3P0A-FP1XP1; TDiff (ns); Energy (keV)", this->h2dsettings.at(11));
	hismanager->RegisterPlot<TH2F>("PID_012", "FP1: Pin 4 Energy vs DB3P0A-FP1XP1; TDiff (ns); Energy (keV)", this->h2dsettings.at(12));

	hismanager->RegisterPlot<TH2F>("PID_013", "FP1: Pin 1 Energy vs DB3P1A-FP1XP1; TDiff (ns); Energy (keV)", this->h2dsettings.at(13));
	hismanager->RegisterPlot<TH2F>("PID_014", "FP1: Pin 2 Energy vs DB3P1A-FP1XP1; TDiff (ns); Energy (keV)", this->h2dsettings.at(14));
	hismanager->RegisterPlot<TH2F>("PID_015", "FP1: Pin 3 Energy vs DB3P1A-FP1XP1; TDiff (ns); Energy (keV)", this->h2dsettings.at(15));
	hismanager->RegisterPlot<TH2F>("PID_016", "FP1: Pin 4 Energy vs DB3P1A-FP1XP1; TDiff (ns); Energy (keV)", this->h2dsettings.at(16));

	hismanager->RegisterPlot<TH2F>("PID_017", "FP1: Pin 1 Energy vs DB3SL-FP1XP1; TDiff (ns); Energy (keV)", this->h2dsettings.at(17));
	hismanager->RegisterPlot<TH2F>("PID_018", "FP1: Pin 2 Energy vs DB3SL-FP1XP1; TDiff (ns); Energy (keV)", this->h2dsettings.at(18));
	hismanager->RegisterPlot<TH2F>("PID_019", "FP1: Pin 3 Energy vs DB3SL-FP1XP1; TDiff (ns); Energy (keV)", this->h2dsettings.at(19));
	hismanager->RegisterPlot<TH2F>("PID_020", "FP1: Pin 4 Energy vs DB3SL-FP1XP1; TDiff (ns); Energy (keV)", this->h2dsettings.at(20));

	hismanager->RegisterPlot<TH2F>("PID_021", "FP1: Pin 1 Energy vs DB3SR-FP1XP1; TDiff (ns); Energy (keV)", this->h2dsettings.at(21));
	hismanager->RegisterPlot<TH2F>("PID_022", "FP1: Pin 2 Energy vs DB3SR-FP1XP1; TDiff (ns); Energy (keV)", this->h2dsettings.at(22));
	hismanager->RegisterPlot<TH2F>("PID_023", "FP1: Pin 3 Energy vs DB3SR-FP1XP1; TDiff (ns); Energy (keV)", this->h2dsettings.at(23));
	hismanager->RegisterPlot<TH2F>("PID_024", "FP1: Pin 4 Energy vs DB3SR-FP1XP1; TDiff (ns); Energy (keV)", this->h2dsettings.at(24));

	hismanager->RegisterPlot<TH2F>("PID_025", "FP1: Pin 1 Energy vs DB5S-FP1XP1; TDiff (ns); Energy (keV)", this->h2dsettings.at(25));
	hismanager->RegisterPlot<TH2F>("PID_026", "FP1: Pin 2 Energy vs DB5S-FP1XP1; TDiff (ns); Energy (keV)", this->h2dsettings.at(26));
	hismanager->RegisterPlot<TH2F>("PID_027", "FP1: Pin 3 Energy vs DB5S-FP1XP1; TDiff (ns); Energy (keV)", this->h2dsettings.at(26));
	hismanager->RegisterPlot<TH2F>("PID_028", "FP1: Pin 4 Energy vs DB5S-FP1XP1; TDiff (ns); Energy (keV)", this->h2dsettings.at(27));
	...
	hismanager->RegisterPlot<TH2F>("PID_109", "FP2: Pin 1 Energy vs DB3P0A-FP2XP1; TDiff (ns); Energy (keV)", this->h2dsettings.at(109));
	hismanager->RegisterPlot<TH2F>("PID_110", "FP2: Pin 2 Energy vs DB3P0A-FP2XP1; TDiff (ns); Energy (keV)", this->h2dsettings.at(110));
	hismanager->RegisterPlot<TH2F>("PID_111", "FP2: Pin 3 Energy vs DB3P0A-FP2XP1; TDiff (ns); Energy (keV)", this->h2dsettings.at(111));
	hismanager->RegisterPlot<TH2F>("PID_112", "FP2: Pin 4 Energy vs DB3P0A-FP2XP1; TDiff (ns); Energy (keV)", this->h2dsettings.at(112));

	hismanager->RegisterPlot<TH2F>("PID_113", "FP2: Pin 1 Energy vs DB3P1A-FP2XP1; TDiff (ns); Energy (keV)", this->h2dsettings.at(113));
	hismanager->RegisterPlot<TH2F>("PID_114", "FP2: Pin 2 Energy vs DB3P1A-FP2XP1; TDiff (ns); Energy (keV)", this->h2dsettings.at(114));
	hismanager->RegisterPlot<TH2F>("PID_115", "FP2: Pin 3 Energy vs DB3P1A-FP2XP1; TDiff (ns); Energy (keV)", this->h2dsettings.at(115));
	hismanager->RegisterPlot<TH2F>("PID_116", "FP2: Pin 4 Energy vs DB3P1A-FP2XP1; TDiff (ns); Energy (keV)", this->h2dsettings.at(116));

	hismanager->RegisterPlot<TH2F>("PID_117", "FP2: Pin 1 Energy vs DB3SL-FP2XP1; TDiff (ns); Energy (keV)", this->h2dsettings.at(117));
	hismanager->RegisterPlot<TH2F>("PID_118", "FP2: Pin 2 Energy vs DB3SL-FP2XP1; TDiff (ns); Energy (keV)", this->h2dsettings.at(118));
	hismanager->RegisterPlot<TH2F>("PID_119", "FP2: Pin 3 Energy vs DB3SL-FP2XP1; TDiff (ns); Energy (keV)", this->h2dsettings.at(119));
	hismanager->RegisterPlot<TH2F>("PID_120", "FP2: Pin 4 Energy vs DB3SL-FP2XP1; TDiff (ns); Energy (keV)", this->h2dsettings.at(120));

	hismanager->RegisterPlot<TH2F>("PID_121", "FP2: Pin 1 Energy vs DB3SR-FP2XP1; TDiff (ns); Energy (keV)", this->h2dsettings.at(121));
	hismanager->RegisterPlot<TH2F>("PID_122", "FP2: Pin 2 Energy vs DB3SR-FP2XP1; TDiff (ns); Energy (keV)", this->h2dsettings.at(122));
	hismanager->RegisterPlot<TH2F>("PID_123", "FP2: Pin 3 Energy vs DB3SR-FP2XP1; TDiff (ns); Energy (keV)", this->h2dsettings.at(123));
	hismanager->RegisterPlot<TH2F>("PID_124", "FP2: Pin 4 Energy vs DB3SR-FP2XP1; TDiff (ns); Energy (keV)", this->h2dsettings.at(124));

	hismanager->RegisterPlot<TH2F>("PID_125", "FP2: Pin 1 Energy vs DB5S-FP2XP1; TDiff (ns); Energy (keV)", this->h2dsettings.at(125));
	hismanager->RegisterPlot<TH2F>("PID_126", "FP2: Pin 2 Energy vs DB5S-FP2XP1; TDiff (ns); Energy (keV)", this->h2dsettings.at(126));
	hismanager->RegisterPlot<TH2F>("PID_127", "FP2: Pin 3 Energy vs DB5S-FP2XP1; TDiff (ns); Energy (keV)", this->h2dsettings.at(126));
	hismanager->RegisterPlot<TH2F>("PID_128", "FP2: Pin 4 Energy vs DB5S-FP2XP1; TDiff (ns); Energy (keV)", this->h2dsettings.at(127));

	hismanager->RegisterPlot<TH2F>("PID_200", "FP1: Pin 2 vs Pin 1 Energy; Energy (keV); Energy (keV)", this->h2dsettings.at(200));
	hismanager->RegisterPlot<TH2F>("PID_201", "FP1: Pin 3 vs Pin 1 Energy; Energy (keV); Energy (keV)", this->h2dsettings.at(201));
	hismanager->RegisterPlot<TH2F>("PID_202", "FP1: Pin 4 vs Pin 1 Energy; Energy (keV); Energy (keV)", this->h2dsettings.at(202));
	hismanager->RegisterPlot<TH2F>("PID_203", "FP2: Pin 2 vs Pin 1 Energy; Energy (keV); Energy (keV)", this->h2dsettings.at(203));
	hismanager->RegisterPlot<TH2F>("PID_204", "FP2: Pin 3 vs Pin 1 Energy; Energy (keV); Energy (keV)", this->h2dsettings.at(204));
	hismanager->RegisterPlot<TH2F>("PID_205", "FP2: Pin 4 vs Pin 1 Energy; Energy (keV); Energy (keV)", this->h2dsettings.at(205));
